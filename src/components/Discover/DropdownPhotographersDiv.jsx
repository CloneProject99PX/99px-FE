...
const DropdownPhotographersDiv = () => {
  ...
  return (
    <StDropdownBox>
      <StDropdownBoxInnerDiv>
        ...
        >
          <StSortContentText>All</StSortContentText>
        ...
        >
          <StSortContentText>Undiscovered</StSortContentText>
...
export default DropdownPhotographersDiv;
